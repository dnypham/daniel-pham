    ...
    return (
      <div id='tools' className='skills-container' ref={this.props.iconRefs.tools}>
        ...
        <div className='row wrap justify-center skill-container-rows'>
          ...
          <div className='skill-container fade-in from-bottom' ref={this.props.iconRefs.npm}>
          ...
          <div className='skill-container fade-in from-bottom' ref={this.props.iconRefs.github}>
            <img className='white' src='images/github.svg'></img>
            <h3 className='nunito-900'>GitHub</h3>
          </div>
          <div className='skill-container fade-in from-bottom' ref={this.props.iconRefs.slack}>
